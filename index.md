...
<div class="hero-modern">
  <div class="hero-content-modern">
    ...
    <h1 class="hero-title-modern">
      <span class="gradient-text">Reter Code</span><br>
    ...
    <div class="hero-buttons-modern">
      ...
      <a href="https://github.com/reter_code-ai/reter_code" class="btn-modern btn-secondary-modern">
...
<span class="code-function">● reter_code:code_inspection</span> <span class="code-string">action="get_architecture"</span>
...
<span class="code-function">● reter_code:diagram</span> <span class="code-string">type="class_hierarchy"</span>
...
<div class="section-dark">
  ...
  <div class="features-grid-modern">
    ...
    <div class="feature-card-modern">
      <div class="feature-icon"><i class="fa-regular fa-clipboard"></i></div>
      <h3>session</h3>
    ...
    <div class="feature-card-modern">
      <div class="feature-icon"><i class="fa-regular fa-hard-drive"></i></div>
...
<div class="section-dark">
  ...
  <div class="tech-grid">
    ...
    <div class="tech-item">
      ...
      <p>claude mcp add reter_code -s user -- uvx ...</p>
    </div>
    <div class="tech-item">
...
<div class="cta-modern">
  ...
  <p>Install the Reter Code MCP server and unlock semantic code analysis.</p>
  <div class="cta-buttons">
    <a href="/docs/getting-started" class="btn-modern btn-primary-modern btn-large">Get Started</a>
    <a href="https://github.com/reter_code-ai/reter_code" class="btn-modern btn-secondary-modern btn-large">View on GitHub</a>
  </div>
</div>
